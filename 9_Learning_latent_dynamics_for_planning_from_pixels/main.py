...
def main():
    ...
    rssm, df = train_rssm(rssm, memory, latent_memory, episode = -1, beta_growth=True) # initial training on warm up data
    ...
    for episode in range(num_episodes):
        ...
        if record_ep:
            ...
            rssm, df = train_rssm(rssm, memory, latent_memory, episode, df)
